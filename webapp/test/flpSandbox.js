		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#devfelipeinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devfelipeinvoices-display": {
								"semanticObject": "devfelipeinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=devfelipe.invoices",
									"url": sap.ui.require.toUrl("devfelipe/invoices")
								}
							}
						}
					}
